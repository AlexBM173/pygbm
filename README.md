...
```
python -m pygbm.cli --y0 <starting-value> --mu <drift-coefficient> --sigma <diffusion-coefficient> --T <total-time> --N <number-of-timesteps> --solver <method-of-solution> --output <gbm-path-filename>
```